// const resetPasswordMail = (user, user_id, admin) => {
const productExpiryMail = (product) => {
  return `
            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: left;">
							<h3>The following product has triggered the expiration alert;</h3>
							<br>
							...
							<br><br>
							Please head to your dashboard to take necessary action
            			</div>
            		</td>
            	</tr>
            </table>
...
module.exports = productExpiryMail;
